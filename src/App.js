...
class Events extends Component {
       ...
       render () {
               ...
               "events": [
                   {
                      "type": "golf",
                       "date": "June 8th",
                       "description": "proceeds from this event benefit the individuals and families of Change, Inc."
                   }
           ...
           const array = EventsList.map(function(obj){
               const rObj = {};
               rObj[obj.type] = obj.date;
               rObj[obj.type] = obj.description;
               return rObj;
           })
